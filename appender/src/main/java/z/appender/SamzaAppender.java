...
/**
 * A Log4J Appender which writes its logs to Kafka 0.8 in a format processable by Samza.
 */
public class SamzaAppender extends AppenderSkeleton {
    ...
    public void activateOptions() {
        try {
            ...
            producerProperties.put("key.serializer.class", "z.appender.serializer.Log4JEncoder");
