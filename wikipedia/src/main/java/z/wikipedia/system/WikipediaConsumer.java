...
import z.wikipedia.system.WikipediaFeed.WikipediaFeedEvent;
import z.wikipedia.system.WikipediaFeed.WikipediaFeedListener;
...
public class WikipediaConsumer extends BlockingEnvelopeMap implements WikipediaFeedListener {
    ...
    public void onEvent(final WikipediaFeedEvent event) {
        SystemStreamPartition systemStreamPartition = new SystemStreamPartition(systemName,
                                                                                event.getChannel(),
                                                                                new Partition(0));
